...
- Env overrides: [Environment variables](./env)
...
- Annotated schema and loader: [pkg/gateway/config/config.go](../annotated/pkg/gateway/config/)
...
- Annotated websocket config: [Config schema](../annotated/pkg/gateway/config/) (search for `WebSocketConfig`)
...
- Config schema and validation: [Config schema](../annotated/pkg/gateway/config/)
- Handler behavior: [Webhook handler](../annotated/pkg/gateway/webhook/handler)
