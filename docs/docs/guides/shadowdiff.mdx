...
- CLI entrypoint: `../annotated/cmd/shadowdiff/main`
- Runner + diffing: `../annotated/internal/shadowdiff/diff`
- Config schema/loading: `../annotated/internal/shadowdiff/config`
- Fixture schema/loading: `../annotated/internal/shadowdiff/fixture`
- Normalization helpers: `../annotated/internal/shadowdiff/normalize`

## Deep dive (tooling)

- Runner script (bash): `./shadowdiff-runner`
- Mock upstreams (node): `./shadowdiff-mocks`
