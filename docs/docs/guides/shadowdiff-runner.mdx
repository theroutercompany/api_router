...
- [Shadowdiff mock upstreams](./shadowdiff-mocks)
...
- Shadowdiff CLI entrypoint: [Shadowdiff CLI](../annotated/cmd/shadowdiff/main)
- Core diff logic: [Diff runner](../annotated/internal/shadowdiff/diff)
- Mock upstreams: [Mock upstreams](./shadowdiff-mocks)
